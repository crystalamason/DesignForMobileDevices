...
if(newsContainer){
    fetch("https://newsapi.org/v1/articles?source=bbc-news&apiKey=f2c7a208cd09447085f4646f137e8e31")
        .then(response => {
            return response.json();
        }).then(news => {
...
if(askJack){
    const askJackFormSubmit = e => {
        ...
        fetch("https://crystalamason.github.io/DesignForMobileDevices/first.html", {mode: "no-cors", method: "POST", body: contact})
            .then(response => {
